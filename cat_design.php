...
<body>
    ...
    <div class="container">
        <div class="headerBox profileHeaderBox">
            <div class="center">
                ...
                <p style="font-size: 44px; font-weight: bold; display: inline-block;">디자인</p>
            </div>
        </div>
    </div>
    </header>
    ...
    <div class="container">
        ...
        <div class="publicData">
            <h1 align="center" style="margin: 15px 0;">#공유된 디자인 포트폴리오</h1>
        ...
        <nav aria-label="Page navigation" style="margin: 30px 0;">
            <ul class="pagination justify-content-center">
                <li class="page-item <?= $prev ? "" : "disabled" ?>">
                    <a class="page-link" href="/cat_design.php?page=<?= $startPage - 1 ?>" tabindex="-1">이전</a>
                </li>

                <?php for ($i = $startPage; $i <= $endPage; $i++) : ?>
                    <li class="page-item <?= $i == $page ? "active" : "" ?>">
                        <a class="page-link" href="/cat_design.php?page=<?= $i ?>">
                            <?= $i ?>
                        </a>
                    </li>
                <?php endfor; ?>
                ...
                <li class="page-item <?= $next ? "" : "disabled" ?>">
                    <a class="page-link" href="/cat_design.php?page=<?= $endPage + 1 ?>">다음</a>
                </li>
            </ul>
        </nav>
    </div>
